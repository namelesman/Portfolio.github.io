...
function ReadmeViewer({ repoName }: { repoName: string }) {
  ...
  useEffect(() => {
    setLoading(true);
    fetch(`https://raw.githubusercontent.com/namelesman/${repoName}/main/README.md`)
      .then((res) => {
        if (res.ok) return res.text();
        // Fallback para branch master caso não ache na main
        return fetch(`https://raw.githubusercontent.com/namelesman/${repoName}/master/README.md`).then(r => {
  ...
  const PROJECTS = [
    {
      ...
      desc: t("jarvisDesc"),
      curiosidade: t("jarvisCuriosity"),
      icon: "🤖",
      repo: "https://github.com/namelesman/J.A.R.V.I.S-Frontend",
      demo: "#",
      tech: [
        {
          name: "Python",
    ...
    },
    {
      ...
      desc: t("gtaDesc"),
      curiosidade: t("gtaCuriosity"),
      icon: "🚗",
      repo: "https://github.com/namelesman/GTA-I-HTML-SCSS-JS",
    ...
    },
    {
      ...
      repoName: "Pacman_js",
      desc: t("pacmanDesc"),
      curiosidade: t("pacmanCuriosity"),
      icon: "👻",
      repo: "https://github.com/namelesman/Pacman_js",
      demo: "#",
      tech: [
        {
          name: "JS",
    ...
    },
    {
      ...
      desc: t("conraDesc"),
      curiosidade: t("conraCuriosity"),
      icon: "👕",
      repo: "https://github.com/namelesman/Conra-ActiveWear",
      demo: "#",
      tech: [
        {
          name: "React",
          svg: (
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="-11.5 -10.232 23 20.463" className="w-16 h-16 mb-2">
    ...
    },
    {
      ...
      desc: t("agathaDesc"),
      curiosidade: t("agathaCuriosity"),
      icon: "🌐",
      repo: "https://github.com/namelesman/Agatha-Diesel",
      demo: "#",
      tech: [
        {
          name: "JS",
    ...
    },
    {
      ...
      repoName: "alunobd",
      desc: t("alunobdDesc"),
      curiosidade: t("alunobdCuriosity"),
      icon: "🗄️",
      repo: "https://github.com/namelesman/alunobd",
      demo: "#",
      tech: [
        {
          name: "Java",
    ...
    <div className="speechWindow">
      <div className="popover">
        ...
        <div className="popoverHeader">
          ...
          <div>
            <h3 className="popoverName">{activeProject.name}</h3>
        ...
        <p className="popoverDesc">
          ...
          <span style={{ fontStyle: "italic" }}>{activeProject.curiosidade}</span>
        </p>
